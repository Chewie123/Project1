...
namespace DoctorDeath
{
    internal static class Constants
    {
        ...
        public static readonly string[] TalentStrings = new[]
        {
    ...
    internal class Spellbook
    {
        ...
        public static readonly Spell DrainSoul = new Spell("Drain Soul", 950, false, true, isChanneled: true,
            isWanted:
                () =>
                    Target.HealthPercent < 50 && Me.HealthPercent > 50 && Me.ItemCount("Soul Shard") < 6 &&
                    Me.CanUse("Drain Soul"));

        public static readonly Spell DrainLife = new Spell("Drain Life", 951, false, true, true, isChanneled: true,
            isWanted: () => Me.HealthPercent < 80 && Me.CanUse("Drain Life"));

        // Affliction misc spells.
        public static readonly Spell LifeTap = new Spell("Life Tap", 1100, false, false,
            isWanted: () => Me.ManaPercent < 20 && Me.HealthPercent > 85 && Me.CanUse("Life Tap") && Target.HealthPercent > 20);
        ...
        public static readonly Spell HealthFunnel = new Spell("Health Funnel", 3, false, false, true, true,
            isWanted:
                () =>
                    Me.GotPet() && Pet.HealthPercent > 0 && Pet.HealthPercent < 80 && Target.GotDebuff("Corruption") &&
                    Target.GotDebuff("Curse of Agony"));

        // Destruction damage spells.
        public static readonly Spell ShadowBolt = new Spell("Shadow Bolt", 1000, false, true,
            isWanted: () => !Me.IsWandEquipped() && Me.CanUse("Shadow Bolt"));
