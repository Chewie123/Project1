    ...
    namespace something
    {
        ...
        {
            string MainSpell = "Frostbolt";//"Frostbolt" if frost
            ...
            public override void Fight()
            {
                ...
                if (this.Player.ManaPercent < 15 || ((this.Player.GetSpellRank("Frostbolt") == 0) && this.Player.ManaPercent <= 40))
                {
                    if (canWand)
                    {
