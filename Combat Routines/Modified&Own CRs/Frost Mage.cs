    ...
    namespace Bokutox
    {
       // This is a modified EmuMage & TwinRovaMage for leveling as frost. Credit goes to Emu&TwinRova for the original script. Credits to MacPod
       public class Bokutox : CustomClass
       {
		  ...
		  //This is my PUBLIC Custom Class. My PRIVATE / Paid CC is available for 5$, or with my Profile Package
		  //If you want to avoid Bans, and are looking to get some awesome Profiles. Please add me on skype
		  //Skype = Froztmage
          ...
          {
             this.Player.Attack();
		  // Change 31 to 37 - if you have Arctic Reach Talent 2/2
          ...
          public override void Fight()
          {
            ...
            //cone of cold -- Add /* and */ at the Start and Finish to "Comment" out this spell.
